...
Button(root, text="SET", command=SET, width=10,
       height=1).grid(row=3, column=0, padx=1, pady=1)
Button(root, text="BFS", command=bfs, width=10,
       height=1).grid(row=4, column=0, padx=1, pady=1)
Button(root, text="DFS", command=dfs, width=10,
       height=1).grid(row=5, column=0, padx=1, pady=1)
Button(root, text="Clear", command=Clear, width=10,
       height=1).grid(row=6, column=0, padx=1, pady=1)
root.mainloop()
